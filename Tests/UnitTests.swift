...
class NgramModelTests {
    ...
    func testUnigramProbability() {
        ...
        let probI = model.unigramProbability("我")
        let probLove = model.unigramProbability("愛")
    ...
    func testBigramProbability() {
        ...
        let prob1 = model.bigramProbability("今天", "天氣")
        let prob2 = model.bigramProbability("天氣", "很好")
    ...
    func testSentenceProbability() {
        ...
        let prob1 = model.sentenceProbability(["我", "愛", "你"])
        let prob2 = model.sentenceProbability(["你", "愛", "我"])
